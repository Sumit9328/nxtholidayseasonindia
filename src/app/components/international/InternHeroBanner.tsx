...
const slides = [
  {
    img: "/assets/international/italy1.webp",
    title: "Italy",
    subtitle: "The Land of Art & Romance",
    desc: "Explore the timeless charm of Italy — from the canals of Venice to the rolling hills of Tuscany, every corner tells a story of beauty and passion.",
  },
  {
    img: "/assets/international/paris (1).jpg",
    title: "Paris",
    subtitle: "City of Lights & Love",
    desc: "Discover the romance of Paris — stroll along the Seine, admire the Eiffel Tower, and fall in love with every sunset in the heart of France.",
  },
  {
    img: "/assets/international/swiss (1).jpg",
    title: "Switzerland",
    subtitle: "Where Nature Meets Serenity",
    desc: "Experience the breathtaking beauty of Switzerland — snow-capped Alps, crystal-clear lakes, and a calm that refreshes your soul.",
  },
];

export default function InternHeroBanner() {
  ...
  return (
    <section className="relative w-full h-[520px] md:h-[580px] rounded-3xl overflow-hidden">
      {/* Slides */}
      {slides.map((slide, i) => (
        <img
          key={i}
